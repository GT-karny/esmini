...
PedalSteerCommand to ControllerRacingWheel via UDP.

Usage:
    python racing_wheel_client.py [--port 9100] [--host 127.0.0.1]

Config required on GT_Sim side (config/racing_wheel.json):
    {
        "input_type": "network",
