...
class SensorData_VirtualDetectionArea;
struct SensorData_VirtualDetectionAreaDefaultTypeInternal;
extern SensorData_VirtualDetectionAreaDefaultTypeInternal _SensorData_VirtualDetectionArea_default_instance_;
}  // namespace osi3
PROTOBUF_NAMESPACE_OPEN
...
template<> ::osi3::SensorData_VirtualDetectionArea* Arena::CreateMaybeMessage<::osi3::SensorData_VirtualDetectionArea>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace osi3 {
...
class SensorData_VirtualDetectionArea PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:osi3.SensorData.VirtualDetectionArea) */ {
 public:
  inline SensorData_VirtualDetectionArea() : SensorData_VirtualDetectionArea(nullptr) {}
  virtual ~SensorData_VirtualDetectionArea();
  explicit constexpr SensorData_VirtualDetectionArea(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  SensorData_VirtualDetectionArea(const SensorData_VirtualDetectionArea& from);
  SensorData_VirtualDetectionArea(SensorData_VirtualDetectionArea&& from) noexcept
    : SensorData_VirtualDetectionArea() {
    *this = ::std::move(from);
  }

  inline SensorData_VirtualDetectionArea& operator=(const SensorData_VirtualDetectionArea& from) {
    CopyFrom(from);
    return *this;
  }
  inline SensorData_VirtualDetectionArea& operator=(SensorData_VirtualDetectionArea&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const SensorData_VirtualDetectionArea& default_instance() {
    return *internal_default_instance();
  }
  static inline const SensorData_VirtualDetectionArea* internal_default_instance() {
    return reinterpret_cast<const SensorData_VirtualDetectionArea*>(
               &_SensorData_VirtualDetectionArea_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    1;

  friend void swap(SensorData_VirtualDetectionArea& a, SensorData_VirtualDetectionArea& b) {
    a.Swap(&b);
  }
  inline void Swap(SensorData_VirtualDetectionArea* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(SensorData_VirtualDetectionArea* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline SensorData_VirtualDetectionArea* New() const final {
    return CreateMaybeMessage<SensorData_VirtualDetectionArea>(nullptr);
  }

  SensorData_VirtualDetectionArea* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<SensorData_VirtualDetectionArea>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const SensorData_VirtualDetectionArea& from);
  void MergeFrom(const SensorData_VirtualDetectionArea& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(SensorData_VirtualDetectionArea* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "osi3.SensorData.VirtualDetectionArea";
  }
  protected:
  explicit SensorData_VirtualDetectionArea(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // repeated .osi3.Polygon3d polygon = 1;
  int polygon_size() const;
  private:
  int _internal_polygon_size() const;
  public:
  void clear_polygon();
  ::osi3::Polygon3d* mutable_polygon(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::osi3::Polygon3d >*
      mutable_polygon();
  private:
  const ::osi3::Polygon3d& _internal_polygon(int index) const;
  ::osi3::Polygon3d* _internal_add_polygon();
  public:
  const ::osi3::Polygon3d& polygon(int index) const;
  ::osi3::Polygon3d* add_polygon();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::osi3::Polygon3d >&
      polygon() const;

  // @@protoc_insertion_point(class_scope:osi3.SensorData.VirtualDetectionArea)
 private:
  class _Internal;
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::osi3::Polygon3d > polygon_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_osi_5fsensordata_2eproto;
};
// -------------------------------------------------------------------
...
class SensorData PROTOBUF_FINAL :
 ...
 public:
  ...
  typedef SensorData_VirtualDetectionArea VirtualDetectionArea;
  ...
  enum : int {
    ...
    kVirtualDetectionAreaFieldNumber = 28,
    kSystemTimeFieldNumber = 29,
  };
  ...
  // optional .osi3.SensorData.VirtualDetectionArea virtual_detection_area = 28;
  bool has_virtual_detection_area() const;
  private:
  bool _internal_has_virtual_detection_area() const;
  public:
  void clear_virtual_detection_area();
  const ::osi3::SensorData_VirtualDetectionArea& virtual_detection_area() const;
  ::osi3::SensorData_VirtualDetectionArea* release_virtual_detection_area();
  ::osi3::SensorData_VirtualDetectionArea* mutable_virtual_detection_area();
  void set_allocated_virtual_detection_area(::osi3::SensorData_VirtualDetectionArea* virtual_detection_area);
  private:
  const ::osi3::SensorData_VirtualDetectionArea& _internal_virtual_detection_area() const;
  ::osi3::SensorData_VirtualDetectionArea* _internal_mutable_virtual_detection_area();
  public:
  void unsafe_arena_set_allocated_virtual_detection_area(
      ::osi3::SensorData_VirtualDetectionArea* virtual_detection_area);
  ::osi3::SensorData_VirtualDetectionArea* unsafe_arena_release_virtual_detection_area();

  // optional .osi3.Timestamp system_time = 29;
  bool has_system_time() const;
  private:
  bool _internal_has_system_time() const;
  public:
  void clear_system_time();
  const ::osi3::Timestamp& system_time() const;
  ::osi3::Timestamp* release_system_time();
  ::osi3::Timestamp* mutable_system_time();
  void set_allocated_system_time(::osi3::Timestamp* system_time);
  private:
  const ::osi3::Timestamp& _internal_system_time() const;
  ::osi3::Timestamp* _internal_mutable_system_time();
  public:
  void unsafe_arena_set_allocated_system_time(
      ::osi3::Timestamp* system_time);
  ::osi3::Timestamp* unsafe_arena_release_system_time();
 ...
 private:
  ...
  ::osi3::SensorData_VirtualDetectionArea* virtual_detection_area_;
  ::osi3::Timestamp* system_time_;
  friend struct ::TableStruct_osi_5fsensordata_2eproto;
};
// ===================================================================
...
// repeated .osi3.Polygon3d polygon = 1;
inline int SensorData_VirtualDetectionArea::_internal_polygon_size() const {
  return polygon_.size();
}
inline int SensorData_VirtualDetectionArea::polygon_size() const {
  return _internal_polygon_size();
}
inline ::osi3::Polygon3d* SensorData_VirtualDetectionArea::mutable_polygon(int index) {
  // @@protoc_insertion_point(field_mutable:osi3.SensorData.VirtualDetectionArea.polygon)
  return polygon_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::osi3::Polygon3d >*
SensorData_VirtualDetectionArea::mutable_polygon() {
  // @@protoc_insertion_point(field_mutable_list:osi3.SensorData.VirtualDetectionArea.polygon)
  return &polygon_;
}
inline const ::osi3::Polygon3d& SensorData_VirtualDetectionArea::_internal_polygon(int index) const {
  return polygon_.Get(index);
}
inline const ::osi3::Polygon3d& SensorData_VirtualDetectionArea::polygon(int index) const {
  // @@protoc_insertion_point(field_get:osi3.SensorData.VirtualDetectionArea.polygon)
  return _internal_polygon(index);
}
inline ::osi3::Polygon3d* SensorData_VirtualDetectionArea::_internal_add_polygon() {
  return polygon_.Add();
}
inline ::osi3::Polygon3d* SensorData_VirtualDetectionArea::add_polygon() {
  // @@protoc_insertion_point(field_add:osi3.SensorData.VirtualDetectionArea.polygon)
  return _internal_add_polygon();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::osi3::Polygon3d >&
SensorData_VirtualDetectionArea::polygon() const {
  // @@protoc_insertion_point(field_list:osi3.SensorData.VirtualDetectionArea.polygon)
  return polygon_;
}
...
// optional .osi3.SensorData.VirtualDetectionArea virtual_detection_area = 28;
inline bool SensorData::_internal_has_virtual_detection_area() const {
  bool value = (_has_bits_[0] & 0x00040000u) != 0;
  PROTOBUF_ASSUME(!value || virtual_detection_area_ != nullptr);
  return value;
}
inline bool SensorData::has_virtual_detection_area() const {
  return _internal_has_virtual_detection_area();
}
inline void SensorData::clear_virtual_detection_area() {
  if (virtual_detection_area_ != nullptr) virtual_detection_area_->Clear();
  _has_bits_[0] &= ~0x00040000u;
}
inline const ::osi3::SensorData_VirtualDetectionArea& SensorData::_internal_virtual_detection_area() const {
  const ::osi3::SensorData_VirtualDetectionArea* p = virtual_detection_area_;
  return p != nullptr ? *p : reinterpret_cast<const ::osi3::SensorData_VirtualDetectionArea&>(
      ::osi3::_SensorData_VirtualDetectionArea_default_instance_);
}
inline const ::osi3::SensorData_VirtualDetectionArea& SensorData::virtual_detection_area() const {
  // @@protoc_insertion_point(field_get:osi3.SensorData.virtual_detection_area)
  return _internal_virtual_detection_area();
}
inline void SensorData::unsafe_arena_set_allocated_virtual_detection_area(
    ::osi3::SensorData_VirtualDetectionArea* virtual_detection_area) {
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(virtual_detection_area_);
  }
  virtual_detection_area_ = virtual_detection_area;
  if (virtual_detection_area) {
    _has_bits_[0] |= 0x00040000u;
  } else {
    _has_bits_[0] &= ~0x00040000u;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:osi3.SensorData.virtual_detection_area)
}
inline ::osi3::SensorData_VirtualDetectionArea* SensorData::release_virtual_detection_area() {
  _has_bits_[0] &= ~0x00040000u;
  ::osi3::SensorData_VirtualDetectionArea* temp = virtual_detection_area_;
  virtual_detection_area_ = nullptr;
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
}
inline ::osi3::SensorData_VirtualDetectionArea* SensorData::unsafe_arena_release_virtual_detection_area() {
  // @@protoc_insertion_point(field_release:osi3.SensorData.virtual_detection_area)
  _has_bits_[0] &= ~0x00040000u;
  ::osi3::SensorData_VirtualDetectionArea* temp = virtual_detection_area_;
  virtual_detection_area_ = nullptr;
  return temp;
}
inline ::osi3::SensorData_VirtualDetectionArea* SensorData::_internal_mutable_virtual_detection_area() {
  _has_bits_[0] |= 0x00040000u;
  if (virtual_detection_area_ == nullptr) {
    auto* p = CreateMaybeMessage<::osi3::SensorData_VirtualDetectionArea>(GetArena());
    virtual_detection_area_ = p;
  }
  return virtual_detection_area_;
}
inline ::osi3::SensorData_VirtualDetectionArea* SensorData::mutable_virtual_detection_area() {
  // @@protoc_insertion_point(field_mutable:osi3.SensorData.virtual_detection_area)
  return _internal_mutable_virtual_detection_area();
}
inline void SensorData::set_allocated_virtual_detection_area(::osi3::SensorData_VirtualDetectionArea* virtual_detection_area) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete virtual_detection_area_;
  }
  if (virtual_detection_area) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(virtual_detection_area);
    if (message_arena != submessage_arena) {
      virtual_detection_area = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, virtual_detection_area, submessage_arena);
    }
    _has_bits_[0] |= 0x00040000u;
  } else {
    _has_bits_[0] &= ~0x00040000u;
  ...
  virtual_detection_area_ = virtual_detection_area;
  // @@protoc_insertion_point(field_set_allocated:osi3.SensorData.virtual_detection_area)
}

// optional .osi3.Timestamp system_time = 29;
inline bool SensorData::_internal_has_system_time() const {
  bool value = (_has_bits_[0] & 0x00080000u) != 0;
  PROTOBUF_ASSUME(!value || system_time_ != nullptr);
  return value;
}
inline bool SensorData::has_system_time() const {
  return _internal_has_system_time();
}
inline const ::osi3::Timestamp& SensorData::_internal_system_time() const {
  const ::osi3::Timestamp* p = system_time_;
  return p != nullptr ? *p : reinterpret_cast<const ::osi3::Timestamp&>(
      ::osi3::_Timestamp_default_instance_);
}
inline const ::osi3::Timestamp& SensorData::system_time() const {
  // @@protoc_insertion_point(field_get:osi3.SensorData.system_time)
  return _internal_system_time();
}
inline void SensorData::unsafe_arena_set_allocated_system_time(
    ::osi3::Timestamp* system_time) {
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(system_time_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:osi3.SensorData.system_time)
}
inline ::osi3::Timestamp* SensorData::release_system_time() {
  _has_bits_[0] &= ~0x00080000u;
  ::osi3::Timestamp* temp = system_time_;
  system_time_ = nullptr;
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
}
inline ::osi3::Timestamp* SensorData::unsafe_arena_release_system_time() {
  // @@protoc_insertion_point(field_release:osi3.SensorData.system_time)
  _has_bits_[0] &= ~0x00080000u;
  ::osi3::Timestamp* temp = system_time_;
  system_time_ = nullptr;
  return temp;
}
inline ::osi3::Timestamp* SensorData::_internal_mutable_system_time() {
  _has_bits_[0] |= 0x00080000u;
  if (system_time_ == nullptr) {
    auto* p = CreateMaybeMessage<::osi3::Timestamp>(GetArena());
    system_time_ = p;
  }
  return system_time_;
}
inline ::osi3::Timestamp* SensorData::mutable_system_time() {
  // @@protoc_insertion_point(field_mutable:osi3.SensorData.system_time)
  return _internal_mutable_system_time();
}
inline void SensorData::set_allocated_system_time(::osi3::Timestamp* system_time) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(system_time_);
  }
  if (system_time) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(system_time)->GetArena();
    if (message_arena != submessage_arena) {
      system_time = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, system_time, submessage_arena);
    }
    _has_bits_[0] |= 0x00080000u;
  } else {
    _has_bits_[0] &= ~0x00080000u;
  ...
  system_time_ = system_time;
  // @@protoc_insertion_point(field_set_allocated:osi3.SensorData.system_time)
}
