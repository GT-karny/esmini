...
inline bool Lane_Classification_LanePairing::_internal_has_antecessor_lane_id() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || antecessor_lane_id_ != nullptr);
  return value;
}
...
inline bool Lane_Classification_LanePairing::_internal_has_successor_lane_id() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  PROTOBUF_ASSUME(!value || successor_lane_id_ != nullptr);
  return value;
}
...
inline bool Lane_Classification::_internal_has_road_condition() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || road_condition_ != nullptr);
  return value;
}
...
inline void Lane_Classification::clear_road_condition() {
  if (road_condition_ != nullptr) road_condition_->Clear();
  _has_bits_[0] &= ~0x00000001u;
}
