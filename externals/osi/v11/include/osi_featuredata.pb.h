...
enum CameraDetection_Color : int {
  ...
  CameraDetection_Color_COLOR_GRAY = 3,
...
class LidarDetection PROTOBUF_FINAL :
 ...
 public:
  ...
  // optional .osi3.Identifier beam_id = 13;
  bool has_beam_id() const;
  private:
  bool _internal_has_beam_id() const;
  public:
  void clear_beam_id();
  const ::osi3::Identifier& beam_id() const;
  ::osi3::Identifier* release_beam_id();
  ::osi3::Identifier* mutable_beam_id();
  void set_allocated_beam_id(::osi3::Identifier* beam_id);
  private:
  const ::osi3::Identifier& _internal_beam_id() const;
  ::osi3::Identifier* _internal_mutable_beam_id();
  public:
  void unsafe_arena_set_allocated_beam_id(
      ::osi3::Identifier* beam_id);
  ::osi3::Identifier* unsafe_arena_release_beam_id();
...
class CameraDetection PROTOBUF_FINAL :
 ...
 public:
  ...
  static constexpr Color COLOR_GRAY =
    CameraDetection_Color_COLOR_GRAY;
...
// optional double radial_velocity = 12;
inline bool LidarDetection::_internal_has_radial_velocity() const {
  bool value = (_has_bits_[0] & 0x00000800u) != 0;
  return value;
}
inline bool LidarDetection::has_radial_velocity() const {
  return _internal_has_radial_velocity();
}
inline void LidarDetection::clear_radial_velocity() {
  radial_velocity_ = 0;
  _has_bits_[0] &= ~0x00000800u;
}
inline double LidarDetection::_internal_radial_velocity() const {
  return radial_velocity_;
}
inline double LidarDetection::radial_velocity() const {
  // @@protoc_insertion_point(field_get:osi3.LidarDetection.radial_velocity)
  return _internal_radial_velocity();
}
inline void LidarDetection::_internal_set_radial_velocity(double value) {
  _has_bits_[0] |= 0x00000800u;
  radial_velocity_ = value;
}
inline void LidarDetection::set_radial_velocity(double value) {
  _internal_set_radial_velocity(value);
  // @@protoc_insertion_point(field_set:osi3.LidarDetection.radial_velocity)
}

// optional .osi3.Identifier beam_id = 13;
inline bool LidarDetection::_internal_has_beam_id() const {
  bool value = (_has_bits_[0] & 0x00000008u) != 0;
  PROTOBUF_ASSUME(!value || beam_id_ != nullptr);
  return value;
}
inline bool LidarDetection::has_beam_id() const {
  return _internal_has_beam_id();
}
inline const ::osi3::Identifier& LidarDetection::_internal_beam_id() const {
  const ::osi3::Identifier* p = beam_id_;
  return p != nullptr ? *p : reinterpret_cast<const ::osi3::Identifier&>(
      ::osi3::_Identifier_default_instance_);
}
inline const ::osi3::Identifier& LidarDetection::beam_id() const {
  // @@protoc_insertion_point(field_get:osi3.LidarDetection.beam_id)
  return _internal_beam_id();
}
inline void LidarDetection::unsafe_arena_set_allocated_beam_id(
    ::osi3::Identifier* beam_id) {
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(beam_id_);
  }
  beam_id_ = beam_id;
  if (beam_id) {
    _has_bits_[0] |= 0x00000008u;
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:osi3.LidarDetection.beam_id)
}
inline ::osi3::Identifier* LidarDetection::release_beam_id() {
  _has_bits_[0] &= ~0x00000008u;
  ::osi3::Identifier* temp = beam_id_;
  beam_id_ = nullptr;
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
...
inline ::osi3::Identifier* LidarDetection::unsafe_arena_release_beam_id() {
  // @@protoc_insertion_point(field_release:osi3.LidarDetection.beam_id)
  _has_bits_[0] &= ~0x00000008u;
  ::osi3::Identifier* temp = beam_id_;
  beam_id_ = nullptr;
  return temp;
}
inline ::osi3::Identifier* LidarDetection::_internal_mutable_beam_id() {
  _has_bits_[0] |= 0x00000008u;
  if (beam_id_ == nullptr) {
    auto* p = CreateMaybeMessage<::osi3::Identifier>(GetArena());
    beam_id_ = p;
...
inline ::osi3::Identifier* LidarDetection::mutable_beam_id() {
  // @@protoc_insertion_point(field_mutable:osi3.LidarDetection.beam_id)
  return _internal_mutable_beam_id();
}
inline void LidarDetection::set_allocated_beam_id(::osi3::Identifier* beam_id) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(beam_id_);
  }
  if (beam_id) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(beam_id)->GetArena();
    if (message_arena != submessage_arena) {
      beam_id = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, beam_id, submessage_arena);
    }
    _has_bits_[0] |= 0x00000008u;
  } else {
    _has_bits_[0] &= ~0x00000008u;
  ...
  beam_id_ = beam_id;
  // @@protoc_insertion_point(field_set_allocated:osi3.LidarDetection.beam_id)
}
