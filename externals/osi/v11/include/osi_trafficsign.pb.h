...
inline std::string* TrafficSign_MainSign_Classification::release_country_revision() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return country_revision_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline std::string* TrafficSign_MainSign_Classification::release_sub_code() {
  ...
  _has_bits_[0] &= ~0x00000008u;
  return sub_code_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
