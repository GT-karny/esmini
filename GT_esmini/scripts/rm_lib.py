...
# Lane type bitmask constants -- mirror of RoadManager.hpp Lane::LaneType.
...
RM_LANE_TYPE_NONE = 1 << 0
RM_LANE_TYPE_DRIVING = 1 << 1
RM_LANE_TYPE_STOP = 1 << 2
RM_LANE_TYPE_SHOULDER = 1 << 3
RM_LANE_TYPE_BIKING = 1 << 4
RM_LANE_TYPE_SIDEWALK = 1 << 5
RM_LANE_TYPE_BORDER = 1 << 6
RM_LANE_TYPE_RESTRICTED = 1 << 7
RM_LANE_TYPE_PARKING = 1 << 8
RM_LANE_TYPE_BIDIRECTIONAL = 1 << 9
RM_LANE_TYPE_MEDIAN = 1 << 10
RM_LANE_TYPE_SPECIAL1 = 1 << 11
RM_LANE_TYPE_SPECIAL2 = 1 << 12
RM_LANE_TYPE_SPECIAL3 = 1 << 13
RM_LANE_TYPE_ROADWORKS = 1 << 14
RM_LANE_TYPE_TRAM = 1 << 15
RM_LANE_TYPE_RAIL = 1 << 16
RM_LANE_TYPE_ENTRY = 1 << 17
RM_LANE_TYPE_EXIT = 1 << 18
RM_LANE_TYPE_OFF_RAMP = 1 << 19
