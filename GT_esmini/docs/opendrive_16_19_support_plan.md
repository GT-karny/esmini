...
- ステータス: **P0〜P5 完了・dev_v0.12 マージ済**(§0 実装状況を参照)
...
| F3週 / P6〜P10 | 未着手 | — | 次=**F3週**(junction優先権ポリシー: P5納品の `GetJunctionPriorities` アクセサを消費し ConflictPointResolver の Evaluate 状態モデルを改修 — 計画§5「F3」/§8実行順 P5→F3週→P6)。その後 P6(virtual junction のパース時正規化) |
