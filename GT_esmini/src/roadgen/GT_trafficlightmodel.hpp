...
// GT_esmini fork of EnvironmentSimulator/Modules/ViewerBase/trafficlightmodel.hpp
// Fork source: esmini commit 8773c463 (verbatim except header-guard rename).
// Re-sync with upstream when ViewerBase/trafficlightmodel.* changes.
#ifndef GT_TRAFFICLIGHT_HPP_
#define GT_TRAFFICLIGHT_HPP_
