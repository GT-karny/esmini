...
// GT-FORK: copied from EnvironmentSimulator/Modules/ViewerBase/trafficlightmodel.cpp
// (upstream base: in-tree state @ ff4fc80c, esmini v3.0.2).
// GT deltas: namespace isolation for standalone GT_RoadGen executable.
// Re-sync against upstream on merges.
